...
# Prepare the regression results
df_results = pd.DataFrame({
    "Variable": model_scaled.params.index,
    "Coefficient": model_scaled.params.round(3),
    "Standard Error": model_scaled.bse.round(3),
    "P-value": model_scaled.pvalues.round(3)
})
...
output_path = "C:/Users/cjfar/ECON 498H (Honors Thesis)/Third Draft/Python Code 3.0/Hypothesis 2/regression_results.xlsx"
with pd.ExcelWriter(output_path) as writer:
    df_results.to_excel(writer, sheet_name="Regression Results", index=False)
